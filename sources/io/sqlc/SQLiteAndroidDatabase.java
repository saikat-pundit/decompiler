...
class SQLiteAndroidDatabase {
    ...
    private static final boolean isPostHoneycomb = true;
    ...
    void executeSqlBatch(String[] strArr, JSONArray[] jSONArrayArr, CallbackContext callbackContext) throws Exception {
        if (this.mydb == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:148:0x02a3 A[Catch: JSONException -> 0x02d8, TRY_ENTER, TryCatch #30 {JSONException -> 0x02d8, blocks: (B:148:0x02a3, B:149:0x02b6), top: B:187:0x02a1 }] */
    /* JADX WARN: Removed duplicated region for block: B:149:0x02b6 A[Catch: JSONException -> 0x02d8, TRY_LEAVE, TryCatch #30 {JSONException -> 0x02d8, blocks: (B:148:0x02a3, B:149:0x02b6), top: B:187:0x02a1 }] */
    /* JADX WARN: Removed duplicated region for block: B:15:0x0041 A[Catch: Exception -> 0x027d, TRY_ENTER, TRY_LEAVE, TryCatch #26 {Exception -> 0x027d, blocks: (B:5:0x001e, B:15:0x0041), top: B:180:0x001e }] */
    /* JADX WARN: Removed duplicated region for block: B:167:0x01d5 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:194:0x020c A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Type inference failed for: r0v12, types: [java.lang.Object, org.json.JSONObject] */
    ...
    /* JADX WARN: Type update failed for variable: r22v0 'this'  ??, new type: io.sqlc.SQLiteAndroidDatabase
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 7531. Try increasing type updates limit count.
    ...
    */
    private void executeSqlBatchStatement(java.lang.String r23, org.json.JSONArray r24, org.json.JSONArray r25) throws java.lang.Exception {
        /*
    ...
    private final int countRowsAffectedCompat(QueryType queryType, String str, JSONArray jSONArray, SQLiteDatabase sQLiteDatabase) throws JSONException {
        ...
        String str2 = "";
        for (int iStart = 0; matcher.find(iStart); iStart = matcher.start(1)) {
        ...
        if (jSONArray != null) {
            ...
            for (int i3 = length; i3 < jSONArray.length(); i3++) {
                jSONArray2.put(i3 - length, jSONArray.get(i3));
            }
        } else {
            jSONArray2 = null;
        }
        if (queryType == QueryType.update) {
            ...
            if (matcher2.find()) {
                try {
                    SQLiteStatement sQLiteStatementCompileStatement = sQLiteDatabase.compileStatement("SELECT count(*) FROM " + matcher2.group(1) + str2);
                    if (jSONArray2 != null) {
                        bindArgsToStatement(sQLiteStatementCompileStatement, jSONArray2);
                    }
            ...
            if (matcher3.find()) {
                try {
                    SQLiteStatement sQLiteStatementCompileStatement2 = sQLiteDatabase.compileStatement("SELECT count(*) FROM " + matcher3.group(1) + str2);
                    bindArgsToStatement(sQLiteStatementCompileStatement2, jSONArray2);
                    return (int) sQLiteStatementCompileStatement2.simpleQueryForLong();
                } catch (Exception e2) {
    ...
    static QueryType getQueryType(String str) {
        ...
        if (matcher.find()) {
            try {
                ...
                return QueryType.valueOf(strGroup.toLowerCase(Locale.ENGLISH));
