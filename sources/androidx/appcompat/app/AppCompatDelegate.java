...
public abstract class AppCompatDelegate {
    ...
    static class SerialExecutor implements Executor {
            ...
            synchronized (this.mLock) {
                this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.AppCompatDelegate$SerialExecutor$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m5lambda$execute$0$androidxappcompatappAppCompatDelegate$SerialExecutor(runnable);
                    }
                });
        ...
        /* synthetic */ void m5lambda$execute$0$androidxappcompatappAppCompatDelegate$SerialExecutor(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
