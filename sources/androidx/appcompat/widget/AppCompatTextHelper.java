            ...
            if (!context.isRestricted()) {
                ...
                try {
                    Typeface font = tintTypedArray.getFont(i, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        ...
                        public void m12lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(int i5) {
                        }

                        @Override // androidx.core.content.res.ResourcesCompat.FontCallback
                        /* JADX INFO: renamed from: onFontRetrieved */
                        public void m13lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(Typeface typeface) {
                            int i5;
