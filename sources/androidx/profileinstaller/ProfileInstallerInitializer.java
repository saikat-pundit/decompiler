...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    void delayAfterFirstFrame(final Context context) {
        Choreographer16Impl.postFrameCallback(new Runnable() { // from class: androidx.profileinstaller.ProfileInstallerInitializer$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m60lambda$delayAfterFirstFrame$0$androidxprofileinstallerProfileInstallerInitializer(context);
            }
        });
    }
    ...
    public void m60lambda$delayAfterFirstFrame$0$androidxprofileinstallerProfileInstallerInitializer(final Context context) {
        Handler handler;
