...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C00941 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C00941) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    public static final <T> Flow<T> m1607catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
