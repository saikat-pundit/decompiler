...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1611boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1612constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static String m1619toStringimpl(Object obj) {
    ...
    public String toString() {
        return m1619toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1613constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1612constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1618plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && (e instanceof List)) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1612constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1612constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1616forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
