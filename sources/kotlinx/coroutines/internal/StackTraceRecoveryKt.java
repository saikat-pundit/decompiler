...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM71constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM71constructorimpl = Result.m71constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM71constructorimpl = Result.m71constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m74exceptionOrNullimpl(objM71constructorimpl) == null) {
            obj2 = objM71constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM71constructorimpl2 = Result.m71constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM71constructorimpl2 = Result.m71constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m74exceptionOrNullimpl(objM71constructorimpl2) == null) {
            obj = objM71constructorimpl2;
        }
