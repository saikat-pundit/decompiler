...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM71constructorimpl = Result.m71constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM71constructorimpl = Result.m71constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m77isFailureimpl(objM71constructorimpl) ? null : objM71constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1599installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1599installSignalHandler$lambda1(Signal signal) {
