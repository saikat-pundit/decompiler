...
public interface SendChannel<E> {
    ...
    Object mo1576trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1591isSuccessimpl(objMo1576trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1585exceptionOrNullimpl = ChannelResult.m1585exceptionOrNullimpl(objMo1576trySendJP2dKIU);
