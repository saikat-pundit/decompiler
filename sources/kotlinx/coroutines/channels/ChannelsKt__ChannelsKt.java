...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM71constructorimpl = Result.m71constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM71constructorimpl = Result.m71constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1581boximpl(Result.m78isSuccessimpl(objM71constructorimpl) ? ChannelResult.INSTANCE.m1596successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1594closedJP2dKIU(Result.m74exceptionOrNullimpl(objM71constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1576trySendJP2dKIU = sendChannel.mo1576trySendJP2dKIU(e);
        if (objMo1576trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        if (ChannelResult.m1591isSuccessimpl(sendChannel.mo1576trySendJP2dKIU(e))) {
            return;
        }
