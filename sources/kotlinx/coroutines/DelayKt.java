...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1623scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1560delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1561toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1561toDelayMillisLRDsOJo(long j) {
        if (Duration.m1416compareToLRDsOJo(j, Duration.INSTANCE.m1508getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1428getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
