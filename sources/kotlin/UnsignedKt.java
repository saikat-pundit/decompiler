...
public final class UnsignedKt {
    ...
    public static final int m424uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m167constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m423uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m167constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m425ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m246constructorimpl(0L) : ULong.m246constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m246constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m246constructorimpl(j3 + ((long) (Long.compare(ULong.m246constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m246constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m426ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m246constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m246constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m246constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m246constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m246constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m167constructorimpl((int) d);
        }
        return UInt.m167constructorimpl(UInt.m167constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m167constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m246constructorimpl((long) d);
        }
        return ULong.m246constructorimpl(ULong.m246constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
