...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m404boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m406constructorimpl(short[] storage) {
    ...
    public boolean equals(Object other) {
        return m409equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m419containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m405constructorimpl(int i) {
        return m406constructorimpl(new short[i]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m411getMh2AYeg(short[] sArr, int i) {
        return UShort.m353constructorimpl(sArr[i]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m416set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m412getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public static java.util.Iterator<UShort> m415iteratorimpl(short[] sArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m347boximpl(m421nextMh2AYeg());
        }
    ...
    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m407containsxj2QHRw(short[] sArr, short s) {
    ...
    public static boolean m408containsAllimpl(short[] sArr, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m414isEmptyimpl(short[] sArr) {
