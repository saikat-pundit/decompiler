...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m220boximpl(int[] iArr) {
        return new UIntArray(iArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m222constructorimpl(int[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m225equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m226equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m229hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m233toStringimpl(int[] iArr) {
    ...
    public boolean m234addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object other) {
        return m225equalsimpl(this.storage, other);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m229hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m233toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m235containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static int[] m221constructorimpl(int i) {
        return m222constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m227getpVg5ArA(int[] iArr, int i) {
        return UInt.m167constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m232setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m228getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public int size() {
        return m228getSizeimpl(this.storage);
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UInt> m231iteratorimpl(int[] iArr) {
        return new Iterator(iArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UInt> iterator() {
        return m231iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m161boximpl(m237nextpVg5ArA());
        }
    ...
    public boolean m235containsWZ4Q5Ns(int i) {
        return m223containsWZ4Q5Ns(this.storage, i);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m223containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public boolean containsAll(Collection<?> elements) {
        ...
        return m224containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m224containsAllimpl(int[] iArr, Collection<UInt> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m230isEmptyimpl(int[] iArr) {
        return iArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m230isEmptyimpl(this.storage);
    }
}
