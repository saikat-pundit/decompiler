...
class UuidKt__UuidKt extends UuidKt__UuidJVMKt {
    ...
    public static final Uuid uuidParseHexDashCommonImpl(String hexDashString) {
        ...
        return Uuid.INSTANCE.fromLongs((jHexToLong$default2 << 16) | (jHexToLong$default << 32) | jHexToLong$default3, (jHexToLong$default4 << 48) | HexExtensionsKt.hexToLong$default(hexDashString, 24, 36, null, 4, null));
    }
