...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m240boximpl(ULong.m246constructorimpl(getMostSignificantBits())), ULong.m240boximpl(ULong.m246constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1556toUByteArrayTcUX1vc() {
        return UByteArray.m143constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m246constructorimpl(j) ^ Long.MIN_VALUE, ULong.m246constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m246constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m246constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1558fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m1557fromUByteArrayGBYM_sE(byte[] ubyteArray) {
