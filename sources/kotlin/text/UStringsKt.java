...
public final class UStringsKt {
    ...
    public static final String m1404toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1406toStringolVBNx4(short s, int i) {
    ...
    public static final String m1405toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1403toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m167constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m83boximpl(UByte.m89constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m167constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m347boximpl(UShort.m353constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM167constructorimpl = UInt.m167constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM167constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM167constructorimpl2 = UInt.m167constructorimpl(i3 * iM167constructorimpl);
            int iM167constructorimpl3 = UInt.m167constructorimpl(UInt.m167constructorimpl(iDigitOf) + iM167constructorimpl2);
            if (Integer.compare(iM167constructorimpl3 ^ Integer.MIN_VALUE, iM167constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM167constructorimpl3;
        }
        return UInt.m161boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM246constructorimpl = ULong.m246constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM246constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM246constructorimpl2 = ULong.m246constructorimpl(j * jM246constructorimpl);
            long jM246constructorimpl3 = ULong.m246constructorimpl(ULong.m246constructorimpl(((long) UInt.m167constructorimpl(iDigitOf)) & 4294967295L) + jM246constructorimpl2);
            if (Long.compare(jM246constructorimpl3 ^ Long.MIN_VALUE, jM246constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM246constructorimpl3;
        }
        return ULong.m240boximpl(j);
    }
}
