...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1407elapsedNowUwyO8pc() {
            return Duration.m1445minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1410plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1446plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1409minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1422equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1442isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1508getZEROUwyO8pc();
                    }
                    long jM1445minusLRDsOJo = Duration.m1445minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1422equalsimpl0(duration, Duration.m1461unaryMinusUwyO8pc(jM1445minusLRDsOJo)) ? Duration.INSTANCE.m1508getZEROUwyO8pc() : Duration.m1446plusLRDsOJo(duration, jM1445minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1422equalsimpl0(mo1409minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1508getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1438hashCodeimpl(Duration.m1446plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1457toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1508getZEROUwyO8pc(), null);
    }
}
