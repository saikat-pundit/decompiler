...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m1515minusLRDsOJo(long duration) {
        return m1517plusLRDsOJo(Duration.m1461unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m1516minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m1446plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m1517plusLRDsOJo(long duration) {
        long jM1431getInWholeSecondsimpl = Duration.m1431getInWholeSecondsimpl(duration);
        int iM1433getNanosecondsComponentimpl = Duration.m1433getNanosecondsComponentimpl(duration);
        if (jM1431getInWholeSecondsimpl == 0 && iM1433getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM1431getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM1431getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM1433getNanosecondsComponentimpl);
        }
        return Duration.m1444isPositiveimpl(duration) ? MAX : MIN;
    }
}
