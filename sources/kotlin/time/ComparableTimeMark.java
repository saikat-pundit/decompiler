...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1408minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo1409minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1410plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1412minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1410plusLRDsOJo(Duration.m1461unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1416compareToLRDsOJo(comparableTimeMark.mo1409minusUwyO8pc(other), Duration.INSTANCE.m1508getZEROUwyO8pc());
        }
    }
}
