...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m161boximpl(m1306nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m167constructorimpl(i3);
    ...
    public int m1306nextpVg5ArA() {
        ...
        this.next = UInt.m167constructorimpl(this.step + i);
        return i;
    }
}
